...
function createParticlesFromText() {
  ...
  ctx.textAlign = "left"; // Alineación a la izquierda para dibujar desde el inicio del texto
  ctx.textBaseline = "top"; // Línea base superior para dibujar desde el inicio del texto

  // Dibujar el texto en el canvas
  ctx.fillText(textEl.textContent, 0, 0);
...
// resizeCanvas(); // No es necesario llamar aquí, se llama en mouseenter
